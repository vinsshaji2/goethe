...
email_accounts = [
    {'smtp_server': 'smtp.gmail.com', 'port': 587, 'username': 'binisree.official@gmail.com', 'password': 'kxnb rqul woqc ytiu', 'to': to, 'subject': Subject},
    {'smtp_server': 'smtp.gmail.com', 'port': 587, 'username': 'Karolinajijo9c@gmail.com', 'password': 'gdke ehvo nlvt kcmu', 'to': to, 'subject': Subject},
    {'smtp_server': 'smtp.gmail.com', 'port': 587, 'username': 'sandrashaju224@gmail.com', 'password': 'mtxp kayc gxie shhd', 'to': to, 'subject': Subject},
    {'smtp_server': 'smtp.gmail.com', 'port': 587, 'username': 'akhilmanikuttanparathanam2021@gmail.com', 'password': 'pwwr wosa ytcd cklj', 'to': to, 'subject': Subject},
    {'smtp_server': 'smtp.gmail.com', 'port': 587, 'username': 'aleenasebastain2006@gmail.com', 'password': 'wkia zfgt vmmm ohtp', 'to': to, 'subject': Subject},
    {'smtp_server': 'smtp.gmail.com', 'port': 587, 'username': 'sanjushazz55@gmail.com', 'password': 'pinx nrrb sjmb mtaa', 'to': to, 'subject': Subject},
    {'smtp_server': 'smtp.gmail.com', 'port': 587, 'username': 'alvinamelvina@gmail.com', 'password': 'requ gpoy vriz uqvt', 'to': to, 'subject': Subject},
]

data_list = [
    ('Binisree Puthan Kozhikkottu Valappil', 'Palakkad', '9072476152', 'Sprechen', 'binisree.official@gmail.com'),
    ('Karolina Jijo', 'Ernakulam', '8943690446', 'Sprechen', 'Karolinajijo9c@gmail.com'),
    ('Sandra Shaju', 'Ernakulam', '9207916149', 'Sprechen', 'sandrashaju224@gmail.com'),
    ('Akhil Manikuttan', 'Kottayam', '8921552110', 'Sprechen', 'akhilmanikuttanparathanam2021@gmail.com'),
    ('Aleena Sebastian', 'Ernakulam', '8921988458', 'Schreiben, Sprechen', 'aleenasebastain2006@gmail.com'),
    ('Sanjid Panachikkathodi', 'Malappuram', '9778758990', 'Lesen, Sprechen', 'sanjushazz55@gmail.com'),
    ('Melvina Vincent', 'Idukki', '7907306086', 'Lesen, Sprechen', 'alvinamelvina@gmail.com'),
]
