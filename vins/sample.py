...
#
#     def __init__(self, start_url: str, num_sessions: int, proxies: list = None, gui_display_seconds: int = 10):
#         """
#         Initialize manager.
#
#         Args:
...
#     manager = ParallelBrowserManager(start_url, n, proxies, gui_display_seconds)
...
result = requests.get("https://www.goethe.de/coe?lang=en&oid=b7601d90379a0cc7d48d1c1b8a2cacc4374e67b572b059245fe0492b12511d69", proxies = {
    'http': proxy,
    'https': proxy
})
